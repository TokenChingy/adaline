...
proc weightedJaccard*(a, b: ptr Fingerprint; cfg: EngineConfig): float =
  let jToken = jaccardRegion(a, b, TokenSegmentStart, TokenSegmentCount)
  let jBigram = jaccardRegion(a, b, BigramSegmentStart, BigramSegmentCount)
  let jContext = jaccardRegion(a, b, ContextSegmentStart, ContextSegmentCount)
